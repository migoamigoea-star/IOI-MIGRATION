...
| -------------------------- | ----------------------------------------------------------------- |
| Form Code                  | `SAPDRP`                                                          |
| Official Name              | `SAP Disaster Recovery (DRP)`                                     |
| Department                 | `IT`                                                              |
| Module                     | `M6 - Disaster Recovery`                                          |
| Site(s)                    | `PRAI`                                                            |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/SAPDRP.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ---------------- | -------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D06-IT-Users     | When item created with FormCode=SAPDRP |
...
SAPDRP_List -> SAPDRP_New -> SAPDRP_View -> SAPDRP_Edit -> SAPDRP_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/SAPDRP.pdf`
...
```text
VERIFICATION CHECKLIST - SAP Disaster Recovery (DRP) (SAPDRP)
...
**Blueprint:** SAPDRP (SAP Disaster Recovery (DRP)) **Input Status:** COMPLETE
...
| 5       | Power Automate flow names follow [DEPT]_[FORM]_[Event] convention | ✅ PASS | IT*SAPDRP*[Event] naming confirmed               |
