...
| Official Name              | `PCN Material Disposal 2025`                                                   |
| Department                 | `STR`                                                                          |
| Module                     | `M2 - Material Disposal`                                                       |
| Site(s)                    | `PRAI`                                                                         |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/PCNMATDISPOSAL2025.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | -------------------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=PCNMATDISPOSAL2025 |
...
PCNMATDISPOSAL2025_List -> PCNMATDISPOSAL2025_New -> PCNMATDISPOSAL2025_View ->
PCNMATDISPOSAL2025_Edit -> PCNMATDISPOSAL2025_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/PCNMATDISPOSAL2025.pdf`
...
```text
VERIFICATION CHECKLIST - PCNMATDISPOSAL2025 (PCN Material Disposal 2025)
