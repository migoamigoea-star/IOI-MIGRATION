...
| -------------------------- | ---------------------------------------------------------------- |
| Form Code                  | `SDCI`                                                           |
| Official Name              | `Safekeeping Direct Charge Items`                                |
| Department                 | `STR`                                                            |
| Module                     | `M4 - Returnable & Direct Items`                                 |
| Site(s)                    | `PRAI`                                                           |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/SDCI.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | ------------------------------------ |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=SDCI |
...
SDCI_List -> SDCI_New -> SDCI_View -> SDCI_Edit -> SDCI_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/SDCI.pdf`
...
```text
VERIFICATION CHECKLIST - SDCI (Safekeeping Direct Charge Items)
