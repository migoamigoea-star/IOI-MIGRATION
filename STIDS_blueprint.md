...
| -------------------------- | ----------------------------------------------------------------- |
| Form Code                  | `STIDS`                                                           |
| Official Name              | `Store Incoming Delivery`                                         |
| Department                 | `STR`                                                             |
| Module                     | `M3 - Store Operations`                                           |
| Site(s)                    | `PRAI`                                                            |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/STIDS.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | ------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=STIDS |
...
STIDS_List -> STIDS_New -> STIDS_View -> STIDS_Edit -> STIDS_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/STIDS.pdf`
...
```text
VERIFICATION CHECKLIST - STIDS (Store Incoming Delivery)
