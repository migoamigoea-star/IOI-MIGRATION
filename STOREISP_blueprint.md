...
| -------------------------- | -------------------------------------------------------------------- |
| Form Code                  | `STOREISP`                                                           |
| Official Name              | `Store Incoming Shipping`                                            |
| Department                 | `STR`                                                                |
| Module                     | `M3 - Store Operations`                                              |
| Site(s)                    | `PRAI`                                                               |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/STOREISP.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | ---------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=STOREISP |
...
STOREISP_List -> STOREISP_New -> STOREISP_View -> STOREISP_Edit -> STOREISP_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/STOREISP.pdf`
...
```text
VERIFICATION CHECKLIST - STOREISP (Store Incoming Shipping)
