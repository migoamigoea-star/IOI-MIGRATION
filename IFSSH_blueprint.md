...
| -------------------------- | ----------------------------------------------------------------- |
| Form Code                  | `IFSSH`                                                           |
| Official Name              | `Issuance Form For Safety`                                        |
| Department                 | `STR`                                                             |
| Module                     | `M6 - Deviation & Safety Items`                                   |
| Site(s)                    | `PRAI`                                                            |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/IFSSH.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | ------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=IFSSH |
...
IFSSH_List -> IFSSH_New -> IFSSH_View -> IFSSH_Edit -> IFSSH_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/IFSSH.pdf`
...
```text
VERIFICATION CHECKLIST - IFSSH (Issuance Form For Safety)
