...
| -------------------------- | ------------------------------------------------------------------ |
| Form Code                  | `MRFAPP`                                                           |
| Official Name              | `Material Return Form Application`                                 |
| Department                 | `STR`                                                              |
| Module                     | `M5 - SAP Store Transactions`                                      |
| Site(s)                    | `PRAI`                                                             |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/MRFAPP.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | -------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=MRFAPP |
...
MRFAPP_List -> MRFAPP_New -> MRFAPP_View -> MRFAPP_Edit -> MRFAPP_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/MRFAPP.pdf`
...
```text
VERIFICATION CHECKLIST - MRFAPP (Material Return Form Application)
