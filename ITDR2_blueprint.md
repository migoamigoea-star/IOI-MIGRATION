...
| -------------------------- | ---------------------------------------------------------------- |
| Form Code                  | `ITDR2`                                                          |
| Official Name              | `Outstanding Tasks register`                                     |
| Department                 | `IT`                                                             |
| Module                     | `M2 - IT Support & Service Requests`                             |
| Site(s)                    | `PRAI`                                                           |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/ITDR2.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ---------------- | ------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D06-IT-Users     | When item created with FormCode=ITDR2 |
...
ITDR2_List -> ITDR2_New -> ITDR2_View -> ITDR2_Edit -> ITDR2_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/ITDR2.pdf`
...
```text
VERIFICATION CHECKLIST - Outstanding Tasks register (ITDR2)
...
**Blueprint:** ITDR2 (Outstanding Tasks register) **Input Status:** COMPLETE
...
| 5       | Power Automate flow names follow [DEPT]_[FORM]_[Event] convention | ✅ PASS | IT*ITDR2*[Event] naming confirmed                |
