...
| -------------------------- | --------------------------------------------------------------- |
| Form Code                  | `ITDR`                                                          |
| Official Name              | `IT Daily Report`                                               |
| Department                 | `IT`                                                            |
| Module                     | `M2 - IT Support & Service Requests`                            |
| Site(s)                    | `PRAI`                                                          |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/ITDR.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ---------------- | ------------------------------------ |
| 1     | Create and submit form                           | Requestor  | D06-IT-Users     | When item created with FormCode=ITDR |
...
ITDR_List -> ITDR_New -> ITDR_View -> ITDR_Edit -> ITDR_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/ITDR.pdf`
...
```text
VERIFICATION CHECKLIST - IT Daily Report (ITDR)
...
**Blueprint:** ITDR (IT Daily Report) **Input Status:** COMPLETE
...
| 5       | Power Automate flow names follow [DEPT]_[FORM]_[Event] convention | ✅ PASS | IT*ITDR*[Event] naming confirmed                 |
