...
| -------------------------- | ---------------------------------------------------------------- |
| Form Code                  | `SAPCA`                                                          |
| Official Name              | `SAP Config Access`                                              |
| Department                 | `IT`                                                             |
| Module                     | `M4 - SAP Management`                                            |
| Site(s)                    | `PRAI`                                                           |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/SAPCA.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ---------------- | ------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D06-IT-Users     | When item created with FormCode=SAPCA |
...
SAPCA_List -> SAPCA_New -> SAPCA_View -> SAPCA_Edit -> SAPCA_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/SAPCA.pdf`
...
```text
VERIFICATION CHECKLIST - SAP Config Access (SAPCA)
...
**Blueprint:** SAPCA (SAP Config Access) **Input Status:** COMPLETE
...
| 5       | Power Automate flow names follow [DEPT]_[FORM]_[Event] convention | ✅ PASS | IT*SAPCA*[Event] naming confirmed                |
