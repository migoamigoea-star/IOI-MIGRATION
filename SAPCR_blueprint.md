...
| -------------------------- | ---------------------------------------------------------------- |
| Form Code                  | `SAPCR`                                                          |
| Official Name              | `SAP & WB Change Request Form`                                   |
| Department                 | `IT`                                                             |
| Module                     | `M4 - SAP Management`                                            |
| Site(s)                    | `PRAI`                                                           |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/SAPCR.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ---------------- | ------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D06-IT-Users     | When item created with FormCode=SAPCR |
...
SAPCR_List -> SAPCR_New -> SAPCR_View -> SAPCR_Edit -> SAPCR_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/SAPCR.pdf`
...
```text
VERIFICATION CHECKLIST - SAP & WB Change Request Form (SAPCR)
...
**Blueprint:** SAPCR (SAP & WB Change Request Form) **Input Status:** COMPLETE
...
| 5       | Power Automate flow names follow [DEPT]_[FORM]_[Event] convention | ✅ PASS | IT*SAPCR*[Event] naming confirmed                |
