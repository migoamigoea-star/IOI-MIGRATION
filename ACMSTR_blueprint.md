...
| -------------------------- | ------------------------------------------------------------------ |
| Form Code                  | `ACMSTR`                                                           |
| Official Name              | `ACM STOCK ITEM REQUEST FOR OTHER`                                 |
| Department                 | `STR`                                                              |
| Module                     | `M6 - Deviation & Safety Items`                                    |
| Site(s)                    | `PRAI`                                                             |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/ACMSTR.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | -------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=ACMSTR |
...
ACMSTR_List -> ACMSTR_New -> ACMSTR_View -> ACMSTR_Edit -> ACMSTR_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/ACMSTR.pdf`
...
```text
VERIFICATION CHECKLIST - ACMSTR (ACM STOCK ITEM REQUEST FOR OTHER)
