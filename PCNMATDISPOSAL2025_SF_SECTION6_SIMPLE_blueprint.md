...
| Official Name              | `PCN Material Disposal Section 6 Simple`                                                          |
| Department                 | `STR`                                                                                             |
| Module                     | `M2 - Material Disposal`                                                                          |
| Site(s)                    | `PRAI`                                                                                            |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | --------------------------------------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE |
...
PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_List -> PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_New ->
PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_View -> PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_Edit ->
PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_List
...
- Path:
  `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE.pdf`
...
```text
VERIFICATION CHECKLIST - PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE (PCN Material Disposal Section 6 Simple)
