...
| Official Name              | `Returnable Items`                                                           |
| Department                 | `STR`                                                                        |
| Module                     | `M4 - Returnable & Direct Items`                                             |
| Site(s)                    | `PRAI`                                                                       |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/RETURNABLESITEMS.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | ------------------------------------------------ |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=RETURNABLESITEMS |
...
RETURNABLESITEMS_List -> RETURNABLESITEMS_New -> RETURNABLESITEMS_View -> RETURNABLESITEMS_Edit ->
RETURNABLESITEMS_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/RETURNABLESITEMS.pdf`
...
```text
VERIFICATION CHECKLIST - RETURNABLESITEMS (Returnable Items)
