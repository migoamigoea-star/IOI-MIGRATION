...
| -------------------------- | --------------------------------------------------------------- |
| Form Code                  | `IAL1`                                                          |
| Official Name              | `Server Reboot Log`                                             |
| Department                 | `IT`                                                            |
| Module                     | `M2 - IT Support & Service Requests`                            |
| Site(s)                    | `PRAI`                                                          |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/IAL1.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ---------------- | ------------------------------------ |
| 1     | Create and submit form                           | Requestor  | D06-IT-Users     | When item created with FormCode=IAL1 |
...
IAL1_List -> IAL1_New -> IAL1_View -> IAL1_Edit -> IAL1_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/IAL1.pdf`
...
```text
VERIFICATION CHECKLIST - Server Reboot Log (IAL1)
...
**Blueprint:** IAL1 (Server Reboot Log) **Input Status:** COMPLETE
...
| 5       | Power Automate flow names follow [DEPT]_[FORM]_[Event] convention | ✅ PASS | IT*IAL1*[Event] naming confirmed                 |
