...
| -------------------------- | --------------------------------------------------------------- |
| Form Code                  | `IAL3`                                                          |
| Official Name              | `IT Event`                                                      |
| Department                 | `IT`                                                            |
| Module                     | `M2 - IT Support & Service Requests`                            |
| Site(s)                    | `PRAI`                                                          |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/IAL3.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ---------------- | ------------------------------------ |
| 1     | Create and submit form                           | Requestor  | D06-IT-Users     | When item created with FormCode=IAL3 |
...
IAL3_List -> IAL3_New -> IAL3_View -> IAL3_Edit -> IAL3_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/IAL3.pdf`
...
```text
VERIFICATION CHECKLIST - IT Event (IAL3)
...
**Blueprint:** IAL3 (IT Event) **Input Status:** COMPLETE
...
| 5       | Power Automate flow names follow [DEPT]_[FORM]_[Event] convention | ✅ PASS | IT*IAL3*[Event] naming confirmed                 |
