...
| -------------------------- | ----------------------------------------------------------------- |
| Form Code                  | `SAPAMR`                                                          |
| Official Name              | `SAP Authorisation Matrix Review`                                 |
| Department                 | `IT`                                                              |
| Module                     | `M4 - SAP Management`                                             |
| Site(s)                    | `PRAI`                                                            |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/SAPAMR.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ---------------- | -------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D06-IT-Users     | When item created with FormCode=SAPAMR |
...
SAPAMR_List -> SAPAMR_New -> SAPAMR_View -> SAPAMR_Edit -> SAPAMR_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/IT/SAPAMR.pdf`
...
```text
VERIFICATION CHECKLIST - SAP Authorisation Matrix Review (SAPAMR)
...
**Blueprint:** SAPAMR (SAP Authorisation Matrix Review) **Input Status:** COMPLETE
...
| 5       | Power Automate flow names follow [DEPT]_[FORM]_[Event] convention | ✅ PASS | IT*SAPAMR*[Event] naming confirmed               |
