# User Story — PCN Material Disposal Section 6 Simple (`PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE`)

> **Department:** STR  
> **Module:** M2 - Material Disposal  
> **Site(s):** PRAI  
> **SharePoint List:** `MainDB_STR`  
> **Form Code:** `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE`

---

## 1. App Overview & Purpose

PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE is migrated as a STR workflow form in MainDB_STR with
FormCode=PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE. The implementation preserves submission,
review/approval routing, auditability, and notification behavior for PRAI operations.
...
> I want to **create and submit form** in the `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE` application,  
> So that the workflow advances to the next approval stage.  
>
> *Trigger:* When item created with FormCode=PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE

**US-02: Review submission and request revision if needed**
> As a **Reviewer** (member of `D20-STR-Reviewers`),  
> I want to **review submission and request revision if needed** in the `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE` application,  
> So that the workflow advances to the next approval stage.  
>
...
> I want to **approve/reject and finalize workflow** in the `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE` application,  
> So that the workflow advances to the next approval stage.  
>
> *Trigger:* When review decision recorded

**US-LIST: Search and filter PCN Material Disposal Section 6 Simple records**
> As an **authorized user**,  
> I want to search, filter, and view PCN Material Disposal Section 6 Simple records in the list screen,  
...
| FormCode       | Single line of text    | Yes      | Constant `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE`       |
...
|--------|---------|------------|
| PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_List | Search and filter PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE records | STR readers, reviewers, approvers |
| PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_New | Create new PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE request | STR requestors |
| PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_View | Read-only detail view | All authorized users |
| PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_Edit | Edit in draft/returned state | Requestor and reviewers |

### Screen Interaction Details

**PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_List Screen**
- Gallery displaying all `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE` records from `MainDB_STR`.
...
- `+ New` button navigates to `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_New` (visible to Initiator role only).
- Tap a row to navigate to `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_View`.

**PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_New / _Edit Screen**
...
**PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_View Screen**
...
Set(varTitle, "PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE-" & Text(Now(), "YYYYMMDD-HHMMSS"))
```
...
Navigate(PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_New, ScreenTransition.Slide)

// Navigate from List to View screen for selected record
Navigate(PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_View, ScreenTransition.None, {varRecord: ThisItem})

// Save (Patch) and navigate back to list
Patch(MainDB, {
    Title: varTitle,
    FormCode: "PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE",
    Status: "Draft",
    SubmittedBy: User(),
    SubmittedDate: Now()
});
Navigate(PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_List, ScreenTransition.Back)
```
...
- `FormCode` must always equal `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE` (system-enforced constant).
...
| ------- | ------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Submit  | STR_PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_Submit  | Item created (FormCode=PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE) | Set Submitted status, stamp SubmittedBy/SubmittedDate, notify reviewers  |
| Review  | STR_PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_Review  | CurrentAction=Review                                          | Route for decision, persist reviewer comments, handle return/reject path |
| Approve | STR_PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_Approve | Reviewer decision=Approve                                     | Set Approved status, stamp ApprovedBy/ApprovedDate, notify stakeholders  |
| Close   | STR_PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_Close   | Final state reached                                           | Lock record and finalize notifications                                   |
...
- [ ] Canvas App screens (`PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_List`, `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_New`, `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_View`, `PCNMATDISPOSAL2025_SF_SECTION6_SIMPLE_Edit`) are functional.
