...
| -------------------------- | ----------------------------------------------------------------- |
| Form Code                  | `SRRI2`                                                           |
| Official Name              | `Stock Return/Request Instruction 2`                              |
| Department                 | `STR`                                                             |
| Module                     | `M5 - SAP Store Transactions`                                     |
| Site(s)                    | `PRAI`                                                            |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/SRRI2.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | ------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=SRRI2 |
...
SRRI2_List -> SRRI2_New -> SRRI2_View -> SRRI2_Edit -> SRRI2_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/SRRI2.pdf`
...
```text
VERIFICATION CHECKLIST - SRRI2 (Stock Return/Request Instruction 2)
