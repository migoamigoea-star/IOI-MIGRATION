...
| -------------------------- | ----------------------------------------------------------------- |
| Form Code                  | `SIROP`                                                           |
| Official Name              | `Stock Item Request Other Purpose`                                |
| Department                 | `STR`                                                             |
| Module                     | `M6 - Deviation & Safety Items`                                   |
| Site(s)                    | `PRAI`                                                            |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/SIROP.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | ------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=SIROP |
...
SIROP_List -> SIROP_New -> SIROP_View -> SIROP_Edit -> SIROP_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/SIROP.pdf`
...
```text
VERIFICATION CHECKLIST - SIROP (Stock Item Request Other Purpose)
