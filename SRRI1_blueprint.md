...
| -------------------------- | ----------------------------------------------------------------- |
| Form Code                  | `SRRI1`                                                           |
| Official Name              | `Stock Return/Request Instruction 1`                              |
| Department                 | `STR`                                                             |
| Module                     | `M5 - SAP Store Transactions`                                     |
| Site(s)                    | `PRAI`                                                            |
| Source PDF                 | `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/SRRI1.pdf` |
...
| ----- | ------------------------------------------------ | ---------- | ----------------- | ------------------------------------- |
| 1     | Create and submit form                           | Requestor  | D20-STR-Users     | When item created with FormCode=SRRI1 |
...
SRRI1_List -> SRRI1_New -> SRRI1_View -> SRRI1_Edit -> SRRI1_List
...
- Path: `Latest_Client_provided_file/PENANG/PRAI_SITE_FORM/STR/SRRI1.pdf`
...
```text
VERIFICATION CHECKLIST - SRRI1 (Stock Return/Request Instruction 1)
