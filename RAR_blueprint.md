...
source_analysis: docs/migration-analysis/Department_01_ADM/RAR_analysis.md
---
...
| Module          | ADM Module                                                |
| Site(s)         | Prai                                                      |
| Source Analysis | docs/migration-analysis/Department_01_ADM/RAR_analysis.md |
| DQ Required     | NO                                                        |
| Complexity      | Medium                                                    |
| Owner           | ADM                                                       |
...
|-------|------------|------------|-------------------|-----------------------------------------------|
| 1     | Submit RAR | Initiator  | D01-ADM-Users     | When CurrentStatus = 'Submitted'              |
| 2     | Review RAR | Reviewer   | D01-ADM-Reviewers | When CurrentStatus = 'Reviewed'               |
| 3     | Decide RAR | Approver   | D01-ADM-Approvers | When CurrentStatus = 'Approved' OR 'Rejected' |
...
```
RAR_List -> RAR_New -> RAR_View
RAR_List -> RAR_View -> RAR_Edit
RAR_View -> RAR_Approval
```
...
- Source PDF: docs/migration-analysis/Department_01_ADM/RAR.pdf
- Analysis file: docs/migration-analysis/Department_01_ADM/RAR_analysis.md
