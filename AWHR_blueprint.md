# Technical Blueprint: AWHR — AWHR Form
...
| -------------------------- | ---------------------------------------------------------------------- |
| Form Code                  | `AWHR`                                                                 |
| Official Name              | `AWHR Form`                                                            |
| Department                 | `HR (Department_05)`                                                   |
| Module                     | `M3 - Employee Records & Information`                                  |
| Site(s)                    | `PRAI (Penang)`                                                        |
| Source PDF                 | `Latest_Client_provided_file/PRAI_DB_Design_Original_File/HR/AWHR.pdf` |
...
```text
AWHR_List -> AWHR_New -> AWHR_Edit -> AWHR_Approval -> AWHR_View -> AWHR_List
```
...
- Path: `Latest_Client_provided_file/PRAI_DB_Design_Original_File/HR/AWHR.pdf`
