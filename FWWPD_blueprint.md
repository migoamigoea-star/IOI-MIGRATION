# Technical Blueprint: FWWPD — FWWPD Form
...
| -------------------------- | ----------------------------------------------------------------------- |
| Form Code                  | `FWWPD`                                                                 |
| Official Name              | `FWWPD Form`                                                            |
| Department                 | `HR (Department_05)`                                                    |
| Module                     | `M3 - Employee Records & Information`                                   |
| Site(s)                    | `PRAI (Penang)`                                                         |
| Source PDF                 | `Latest_Client_provided_file/PRAI_DB_Design_Original_File/HR/FWWPD.pdf` |
...
```text
FWWPD_List -> FWWPD_New -> FWWPD_Edit -> FWWPD_Approval -> FWWPD_View -> FWWPD_List
```
...
- Path: `Latest_Client_provided_file/PRAI_DB_Design_Original_File/HR/FWWPD.pdf`
